...
const initTipBox = () => {
  tip = g.simpleButton('x25', 0, 0, 30, 6, K.b, 32, 0, 90, 40)
  tip.alpha = 0.7
...
const initBottomPanel = () => {
  bottomPanel = g.rectangle(g.stage.width, panelHeight, '#311', 10, 0, g.stage.height - panelHeight)
  ...
  const b1 = g.simpleButton(0, 10, 10, 100, 23)
  const b2 = g.simpleButton(0, 120, 10, 100, 23)
  const b3 = g.simpleButton(0, 230, 10, 100, 23)
  const b4 = g.simpleButton(0, 340, 10, 100, 23, K.b)
