...
export const gameOver = () => {
  if (HQ.health <= 0) {
    ...
    g.makeText(b, 'GAME OVER', "99px sans-serif", K.r, x - 300, y - 200)
    const k = makeGold(x - 237, y + 70)
    b.addChild(k)
    g.makeText(b, `${totalGold}`, '35px sans-serif', K.w, x - 193, y + 78)
    g.makeText(b, `k ${currentKills}`, '35px sans-serif', K.w, x - 220, y + 120)
    uiLayer.addChild(b)
  }
}